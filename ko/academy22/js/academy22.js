document.addEventListener("DOMContentLoaded", function() {
    document.getElementsByTagName("main")[0].innerHTML = document.getElementsByTagName("main")[0].innerHTML
        ...
        .replace(/ 色聲香味觸法/g, ' <ruby>色聲香味觸法<rt>색성향미촉법</rt></ruby>')
        ...
        .replace(/ 代表的/g, ' <ruby>代表的<rt>대표적</rt></ruby>')
        .replace(/ 一週日/g, ' <ruby>一週日<rt>일주일</rt></ruby>')
        ...
        .replace(/ 三位/g, ' <ruby>三位<rt>삼위</rt></ruby>')
        ...
        .replace(/ 敎訓/g, ' <ruby>敎訓<rt>교훈</rt></ruby>')
        .replace(/ 動物/g, ' <ruby>動物<rt>동물</rt></ruby>')
        .replace(/ 世界/g, ' <ruby>世界<rt>세계</rt></ruby>')
        .replace(/ 機能/g, ' <ruby>機能<rt>기능</rt></ruby>')
        .replace(/ 氣分/g, ' <ruby>氣分<rt>기분</rt></ruby>')
        .replace(/ 歷史/g, ' <ruby>歷史<rt>역사</rt></ruby>')
        .replace(/ 瞬間/g, ' <ruby>瞬間<rt>순간</rt></ruby>')
        .replace(/ 目的/g, ' <ruby>目的<rt>목적</rt></ruby>')
        .replace(/ 瞋心/g, ' <ruby>瞋心<rt>진심</rt></ruby>')
        .replace(/ 憤怒/g, ' <ruby>憤怒<rt>분노</rt></ruby>')
        .replace(/ 意識/g, ' <ruby>意識<rt>의식</rt></ruby>')
        .replace(/ 除去/g, ' <ruby>除去<rt>제거</rt></ruby>')
        .replace(/ 對話/g, ' <ruby>對話<rt>대화</rt></ruby>')
        .replace(/ 愉快/g, ' <ruby>愉快<rt>유쾌</rt></ruby>')
        .replace(/ 淨化/g, ' <ruby>淨化<rt>정화</rt></ruby>')
        .replace(/ 不快/g, ' <ruby>不快<rt>불쾌</rt></ruby>')
        .replace(/ 한番/g, ' <ruby>한番<rt>　번</rt></ruby>')
        ...
        .replace(/ 通/g, ' <ruby>通<rt>통</rt></ruby>');
});